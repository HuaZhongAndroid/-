...
public class ImagePagerAdapters280 extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup view, int position) {
		...
		if(imageView == null){
			...
			System.out.println("dfssdfsdf:"+imageUrl+"     imageView"+imageView);
			int w = App.getInstance().getScreenWidth();
			int h = (300*w)/700;
			imageView.setLayoutParams(new LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT,h));
			imageView.setScaleType(ScaleType.CENTER_CROP);
			ImageLoader.getInstance().displayImage(imageUrl, imageView,  App.getInstance().getListViewDisplayImageOptions());
