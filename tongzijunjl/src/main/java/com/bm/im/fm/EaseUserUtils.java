...
public class EaseUserUtils {
    ...
    public static void setUserAvatar(Context context, String username, ImageView imageView){
		...
		.showImageOnLoading(R.drawable.my_defa_head)
		.showImageForEmptyUri(R.drawable.my_defa_head)
		.showImageOnFail(R.drawable.my_defa_head).cacheInMemory(true)
	...
	private static void getGroupInfo(final String toChatUsername,final ImageView imageView,final Context context,final DisplayImageOptions	headOptions) {
		...
		IMService.getInstance().findGroupInfo(context, map, new ServiceCallback<CommonResult<CoachInfo>>() {
