...
public class EaseConversationListFragment extends EaseBaseFragment{
    ...
    protected void initView() {
        ...
        etb=(EaseTitleBar) getView().findViewById(R.id.etb);
        //会话列表控件
        ...
        RelativeLayout rl_search_bar = (RelativeLayout) getView().findViewById(R.id.rl_search_bar);
        rl_search_bar.setVisibility(View.GONE);
        
        img_none=(ImageView) getView().findViewById(R.id.img_none);
