...
public class FriendAc extends BaseActivity implements OnClickListener{
	...
	List<CoachInfo> listFriend = new ArrayList<CoachInfo>();
	List<CoachInfo> listGroup = new ArrayList<CoachInfo>();
	...
	public void init(){
		...
		lv_friend.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
					long arg3) {
				if(listFriend.get(position).friendUserId.equals(App.getInstance().getCoach().coachId)){
	...
	public void getMyFriends() {
		...
		IMService.getInstance().findFriendList(mContext, map, new ServiceCallback<CommonListResult<CoachInfo>>() {
	...
	public void getMyGroups() {
		...
		IMService.getInstance().findGroupList(mContext, map, new ServiceCallback<CommonListResult<CoachInfo>>() {
