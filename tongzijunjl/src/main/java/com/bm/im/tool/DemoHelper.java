...
import com.bm.im.db.DemoDBManager;
import com.bm.im.db.InviteMessgeDao;
import com.bm.im.db.UserDao;
import com.bm.im.entity.InviteMessage;
import com.bm.im.entity.InviteMessage.InviteMesageStatus;
...
public class DemoHelper {
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName,final String inviter, String reason) {
            ...
            ImApi.getAppSys(null,inviter, null);
            ...
            msg.addBody(new TextMessageBody( " 有朋友" +st3));
            // 保存邀请消息
...
//            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
        ...
        public void onGroupDestroy(String groupId, String groupName) {
            ...
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_QUIT));
        }
...
//        appContext.startActivity(intent);
	...
	private EaseUser getUserInfo(String username){
        ...
        if(username != null){
        	...
        	if(null!=getContactList()){
        		if(null!=getContactList().get(username)){
...
//        user.setAvatar("http://www.baidu.com");
    ...
    public void saveContact(EaseUser user){
    	if(null !=user){
    		if(null!=user.getUsername()&&null!=contactList){
    			 System.out.println("海盐"+contactList);
