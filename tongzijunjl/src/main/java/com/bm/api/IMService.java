...
//		asyncFormPostNoFileFms(API_IM_FINDUSERGROUPLIST, map,callback);
	 ...
	 * @param callback
	 */
	public void findaddressList(HashMap<String, String> map, final ServiceCallback<CommonListResult<User>> callback){
//		asyncFormPostNoFileFms(API_IM_FINDADDRESSLIST, map,callback);
	}
	 ...
	 * @param callback
	 */
	public void findFriendList(Context context,HashMap<String, String> map, final ServiceCallback<CommonListResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_FRIENDLIST, map, callback);
	}
	/**
	 *  好友-群
	 * @param loginPost 
	 * @param callback
	 */
	public void findGroupList(Context context,HashMap<String, String> map, final ServiceCallback<CommonListResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_GROUPLIST, map, callback);
	}
	/**
	 *  群信息
	 * @param loginPost 
	 * @param callback
	 */
	public void findGroupInfo(Context context,HashMap<String, String> map, final ServiceCallback<CommonResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_GROUPDETAIL, map, callback);
	}
	 ...
	 * @param callback
	 */
	public void getImAddGroupInfo(Context context,HashMap<String, String> map, final ServiceCallback<StringResult> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_IM_ADDGTOUPUINFO, map, callback);
	}
	 ...
	 * @param callback
	 */
	public void getImUpdateGroup(Context context,HashMap<String, String> map, final ServiceCallback<StringResult> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_IM_UPDATEGROUP, map, callback);
//		List<File> files = new ArrayList<File>();
//		if (!TextUtils.isEmpty(imagePath)) {
//			files.add(new File(imagePath));
//		}
//		AsyncHttpHelp.getInstance().httpPost(context, API_IM_UPDATEGROUP, map, "groupPic", files, callback);
	}
	 ...
	 * @param callback
	 */
	public void findNewFriendList(Context context,HashMap<String, String> map, final ServiceCallback<CommonListResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_USERFRIENDLIST, map, callback);
	}
	/**
	 *  查找朋友-好朋友
	 * @param loginPost 
	 * @param callback
	 */
	public void findMyFriendList(Context context,HashMap<String, String> map, final ServiceCallback<CommonListResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_STATUSLIST, map, callback);
	}
	/**
	 *  查找朋友-找朋友
	 * @param loginPost 
	 * @param callback
	 */
	public void getFriendsList(Context context,HashMap<String, String> map, final ServiceCallback<CommonListResult<CoachInfo>> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_SEARCH_USERLIST, map, callback);
	}
	/**
	 *  加好友
	 * @param loginPost 
	...
	public void addFriend(Context context,HashMap<String, String> map, final ServiceCallback<StringResult> callback){
		AsyncHttpHelp.getInstance().httpGet(context, API_ADD_FRIEND, map, callback);
	}
